...
public class MainActivityDoctorSeeUpcomingAppointments extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main_doctor_see_upcoming_appointments);
                ...
                if (snapshot.exists()) {
                    ...
                    for (DataSnapshot person : snapshot.getChildren()) {
                        ...
                        if (status.equals("pending")) {
                            LinearLayout layout = new LinearLayout(MainActivityDoctorSeeUpcomingAppointments.this,null,0, R.style.ApplicantLinearLayout);
                            layout.setLayoutParams(params1);
                            TextView textView = new TextView(MainActivityDoctorSeeUpcomingAppointments.this,null,0,R.style.ApplicantNameView);
                            MaterialButton acceptButton = new MaterialButton(MainActivityDoctorSeeUpcomingAppointments.this, null);
                            MaterialButton rejectButton = new MaterialButton(MainActivityDoctorSeeUpcomingAppointments.this, null);
                            ...
                            textView.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    Intent intent = new Intent(MainActivityDoctorSeeUpcomingAppointments.this, MainActivitySeeUserInfo.class);
